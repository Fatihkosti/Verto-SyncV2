...
fun buildPermissionSections(): List<PermissionSection> = listOf(
    PermissionSection(
    ...
    PermissionSection(
        key = "clients", label = "العملاء والموردون",
        subPermissions = listOf(
    ...
    PermissionSection(
        key = "payments", label = "المدفوعات والصندوق",
        subPermissions = listOf(
    ...
    PermissionSection(
        key = "marketing", label = "لوحات المسوّقين",
        subPermissions = listOf(
